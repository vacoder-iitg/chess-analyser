...
import statistics
import time
from game_engine import analyze_game 
...
def run_batch(): 
    ...
    with open(PGN_FILE) as pgn:
        while True:
            ...
            # Advanced Structural Fragility Breakdown
            ...
            # Trigger graph visualization export
            plot_game_metrics(data, game_id=str(game_count))
